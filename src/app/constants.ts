...
export const COLOR_PALETTES = [
  ...
  { id: 'blood',    bg: '#440000', fg: '#FF4444', bar: '#440000', frame: 'rgba(255,68,68,0.5)',   muted: 'rgba(255,68,68,0.55)',  primary: 'rgba(255,68,68,0.9)',     selBg: '#FF4444', selFg: '#440000', hoverBg: '#FF4444', hoverFg: '#440000' },
] as const;
