...
const PRESETS: Record<string, { macros: MacroState; palette: string }> = {
  ...
  CLEAN:  { macros: { DITHER: 0.2, MOTION: 0.3, GLOW: 0.2, TRAIL: 0.1, BURST: 0.1, PULSE: 0.2, GHOST: 0.1, DENSITY: 0.5, WARP: 0.0, FADE: 0.6, SCALE: 0.4, ZOOM: 0, INVERT: 0, SCAN: 0, VOID: 0, DRIFT: 0.1, FOCUS: 0.3, SHAPE: 0, PERSP: 0 }, palette: 'code' },
  CHAOS:  { macros: { DITHER: 0.9, MOTION: 0.95, GLOW: 0.85, TRAIL: 0.9, BURST: 0.95, PULSE: 0.8, GHOST: 0.7, DENSITY: 0.7, WARP: 0.8, FADE: 0.8, SCALE: 0.7, ZOOM: 0.5, INVERT: 0, SCAN: 0, VOID: 0.2, DRIFT: 0.6, FOCUS: 0.1, SHAPE: 0.7, PERSP: 0.3 }, palette: 'signal' },
  VAPOR:  { macros: { DITHER: 0.6, MOTION: 0.3, GLOW: 0.8, TRAIL: 0.7, BURST: 0.2, PULSE: 0.6, GHOST: 0.8, DENSITY: 0.4, WARP: 0.4, FADE: 0.3, SCALE: 0.6, ZOOM: 0.2, INVERT: 0, SCAN: 0, VOID: 0.1, DRIFT: 0.4, FOCUS: 0.6, SHAPE: 0.3, PERSP: 0.4 }, palette: 'braille' },
  STATIC: { macros: { DITHER: 0.8, MOTION: 0.1, GLOW: 0.4, TRAIL: 0.2, BURST: 0.3, PULSE: 0.1, GHOST: 0.3, DENSITY: 0.5, WARP: 0.1, FADE: 0.4, SCALE: 0.5, ZOOM: 0.1, INVERT: 1, SCAN: 1, VOID: 0.3, DRIFT: 0, FOCUS: 0.2, SHAPE: 0.5, PERSP: 0 }, palette: 'binary' },
  DEEP:   { macros: { DITHER: 0.4, MOTION: 0.5, GLOW: 0.7, TRAIL: 0.8, BURST: 0.4, PULSE: 0.7, GHOST: 0.9, DENSITY: 0.3, WARP: 0.6, FADE: 0.2, SCALE: 0.65, ZOOM: 0.3, INVERT: 0, SCAN: 0, VOID: 0.15, DRIFT: 0.3, FOCUS: 0.4, SHAPE: 0, PERSP: 0.5 }, palette: 'code' },
  PULSE:  { macros: { DITHER: 0.4, MOTION: 0.6, GLOW: 0.8, TRAIL: 0.5, BURST: 0.3, PULSE: 0.95, GHOST: 0.5, DENSITY: 0.5, WARP: 0.1, FADE: 0.4, SCALE: 0.5, ZOOM: 0.15, INVERT: 0, SCAN: 0, VOID: 0.05, DRIFT: 0.2, FOCUS: 0.3, SHAPE: 0, PERSP: 0 }, palette: 'signal' },
  DRIFT:  { macros: { DITHER: 0.3, MOTION: 0.2, GLOW: 0.5, TRAIL: 0.85, BURST: 0.1, PULSE: 0.3, GHOST: 0.7, DENSITY: 0.4, WARP: 0.2, FADE: 0.2, SCALE: 0.55, ZOOM: 0.1, INVERT: 0, SCAN: 0, VOID: 0.05, DRIFT: 0.8, FOCUS: 0.5, SHAPE: 0, PERSP: 0.3 }, palette: 'braille' },
  VOID:   { macros: { DITHER: 0.3, MOTION: 0.3, GLOW: 0.1, TRAIL: 0.3, BURST: 0.2, PULSE: 0.2, GHOST: 0.4, DENSITY: 0.2, WARP: 0.15, FADE: 0.2, SCALE: 0.4, ZOOM: 0.1, INVERT: 1, SCAN: 0, VOID: 0.7, DRIFT: 0.1, FOCUS: 0.2, SHAPE: 0.8, PERSP: 0 }, palette: 'slash' },
  GLITCH: { macros: { DITHER: 0.7, MOTION: 0.5, GLOW: 0.4, TRAIL: 0.1, BURST: 0.5, PULSE: 0.3, GHOST: 0.1, DENSITY: 0.5, WARP: 0.9, FADE: 0.6, SCALE: 0.5, ZOOM: 0.6, INVERT: 0, SCAN: 1, VOID: 0.15, DRIFT: 0.3, FOCUS: 0.1, SHAPE: 0.6, PERSP: 0 }, palette: 'binary' },
  MATRIX: { macros: { DITHER: 0.5, MOTION: 0.9, GLOW: 0.5, TRAIL: 0.6, BURST: 0.15, PULSE: 0.4, GHOST: 0.4, DENSITY: 0.6, WARP: 0.2, FADE: 0.5, SCALE: 0.5, ZOOM: 0.2, INVERT: 0, SCAN: 0, VOID: 0, DRIFT: 0.7, FOCUS: 0.2, SHAPE: 0.4, PERSP: 0 }, palette: 'katakana' },
  // New presets using new palettes + perspective
  RUNES:  { macros: { DITHER: 0.4, MOTION: 0.4, GLOW: 0.6, TRAIL: 0.5, BURST: 0.3, PULSE: 0.3, GHOST: 0.6, DENSITY: 0.4, WARP: 0.3, FADE: 0.3, SCALE: 0.5, ZOOM: 0.1, INVERT: 0, SCAN: 0, VOID: 0.1, DRIFT: 0.2, FOCUS: 0.4, SHAPE: 0, PERSP: 0.6 }, palette: 'runic' },
  COSMIC: { macros: { DITHER: 0.3, MOTION: 0.2, GLOW: 0.9, TRAIL: 0.7, BURST: 0.2, PULSE: 0.5, GHOST: 0.8, DENSITY: 0.3, WARP: 0.5, FADE: 0.2, SCALE: 0.6, ZOOM: 0.15, INVERT: 0, SCAN: 0, VOID: 0.05, DRIFT: 0.3, FOCUS: 0.5, SHAPE: 0.2, PERSP: 0.7 }, palette: 'stars' },
  GRID:   { macros: { DITHER: 0.5, MOTION: 0.3, GLOW: 0.3, TRAIL: 0.3, BURST: 0.2, PULSE: 0.2, GHOST: 0.3, DENSITY: 0.5, WARP: 0, FADE: 0.4, SCALE: 0.5, ZOOM: 0, INVERT: 0, SCAN: 0, VOID: 0.2, DRIFT: 0, FOCUS: 0.6, SHAPE: 1, PERSP: 0 }, palette: 'box' },
  OMEGA:  { macros: { DITHER: 0.6, MOTION: 0.5, GLOW: 0.5, TRAIL: 0.4, BURST: 0.3, PULSE: 0.4, GHOST: 0.5, DENSITY: 0.4, WARP: 0.2, FADE: 0.3, SCALE: 0.5, ZOOM: 0.1, INVERT: 0, SCAN: 0, VOID: 0.1, DRIFT: 0.15, FOCUS: 0.3, SHAPE: 0, PERSP: 0.4 }, palette: 'greek' },
};
