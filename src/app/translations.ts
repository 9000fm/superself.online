...
export const translations: Record<Language, TranslationKeys> = {
  ES: {
    ...
    aboutText: '(2023) es un colectivo y sello de música electrónica nacido en Lima, Perú. El proyecto comenzó con la idea de compartir sonidos que realmente nos gustan y sentimos cercano. En este espacio publicamos mezclas, lanzamientos propios y una selección de música que nos representa. Dejanos tu mail para recibir novedades.',
    close: 'Cerrar',
  ...
  EN: {
    ...
    aboutText: '(2023) is an electronic music collective and label born in Lima, Peru. The project started with the idea of sharing sounds we truly enjoy and feel close to. Here we publish mixes, original releases and a selection of music that represents us. Leave your email to get updates.',
    close: 'Close',
    shopTitle: 'shop.exe',
  ...
  JP: {
    ...
    ok: '開く',
    aboutTitle: '概要.txt',
    aboutText: '(2023) はリマ、ペルー発の電子音楽コレクティブ＆レーベル。本当に好きで近いと感じるサウンドを共有するというアイデアから始まった。ここではミックス、自主リリース、そして自分たちを表す音楽のセレクションを発信中。メールを残して最新情報を受け取ろう。',
    close: '閉じる',
    shopTitle: '店舗.exe',
